...
export const PunishmentTypeCard = ({
  ...
  return (
    <Link href={href}>
      <Card
        className={cn(
          "overflow-hidden mx-auto w-60 h-36 flex-col flex items-center relative transition ease-in-out hover:scale-110 hover:bg-gradient-to-tr to-transparent group",
          fromGradient,
        )}
      >
        {punishmentIcon}
        <CardContent className="text-center mt-auto z-[1]">
          <MotionNumber
            ...
            format={{
              notation: "standard",
              useGrouping: false,
              minimumIntegerDigits: count.toString().length,
            }}
