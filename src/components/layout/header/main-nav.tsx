  ...
  return (
    <div className="mr-4 hidden md:flex">
      <Link href="/" className="mr-6 flex items-center space-x-2">
        <WebsiteLogo width={24} height={24} />
      ...
      <nav className="flex items-center gap-6 text-sm">
        ...
        >
          ...
          <Badge
            ...
            className="!px-1 !py-0 hidden lg:inline-flex"
          >
            {bans}
          </Badge>
        </Link>
        ...
        >
          ...
          <Badge
            variant={pathname.startsWith("/mutes") ? "default" : "secondary"}
            className="!px-1 !py-0 hidden lg:inline-flex"
          >
            {mutes}
          </Badge>
        ...
        >
          ...
          <Badge
            variant={pathname.startsWith("/warns") ? "default" : "secondary"}
            className="!px-1 !py-0 hidden lg:inline-flex"
          >
            {warns}
          </Badge>
        ...
        >
          ...
          <Badge
            variant={pathname.startsWith("/kicks") ? "default" : "secondary"}
            className="!px-1 !py-0 hidden lg:inline-flex"
          >
            {kicks}
          </Badge>
